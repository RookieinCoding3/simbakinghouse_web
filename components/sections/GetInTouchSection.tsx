...
export default function GetInTouchSection() {
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-bakery-dark via-bakery-brown to-bakery-dark">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="font-body text-bakery-cream/80 text-lg max-w-2xl mx-auto">
            Can&apos;t find the right ingredient? Need recipe tips? Sim is always happy to help!
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          >
            <div className="w-16 h-16 bg-bakery-accent/20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-bakery-accent/30 transition-colors">
              <svg className="w-8 h-8 text-bakery-accent" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                <path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
            </div>
            <h3 className="font-heading text-bakery-cream text-xl mb-2 tracking-wide">
              VISIT OUR STORE
            </h3>
            <p className="font-body text-bakery-cream/70 text-sm mb-3">
              Penang, Malaysia
            </p>
          ...
          >
            ...
            <p className="font-body text-green-400 text-sm font-semibold">
              Chat with Sim directly
            </p>
          </a>
        ...
        <div className="text-center">
          <p className="font-body text-bakery-cream/60 text-sm mb-4">
          ...
          <div className="flex items-center justify-center space-x-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-bakery-cream/60 hover:text-bakery-accent transition-colors duration-200"
              aria-label="Facebook"
            >
