      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <a
            ...
            className="inline-flex items-center space-x-2 text-clay hover:text-clay/80 font-body text-base transition-colors duration-200 group"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
          {posts.map((post, index) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative aspect-square overflow-hidden rounded-lg bg-clay/10 hover-scale animate-fade-in-up"
            ...
            >
              ...
              {/* Hover Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-ink/80 via-ink/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
