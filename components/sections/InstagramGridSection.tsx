      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <a
            ...
            className="inline-flex items-center space-x-2 text-bakery-accent hover:text-bakery-accent/80 font-body text-base transition-colors duration-200 group"
          >
            ...
            <span className="font-heading tracking-wide">@sim_baking_house</span>
          </a>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
          {posts.map((post, index) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative aspect-square overflow-hidden rounded-lg bg-bakery-accent/10 hover-scale animate-fade-in-up"
            ...
            >
              ...
              {/* Hover Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-bakery-brown/80 via-bakery-brown/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
        ...
        <div className="text-center mt-10">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center space-x-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-heading px-8 py-3 rounded-full hover:shadow-lg transition-all duration-300 hover-scale"
          >
