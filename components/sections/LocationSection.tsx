      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10">
            <div>
              <h1 className="font-heading text-ink text-5xl md:text-6xl mb-4 leading-none">
                VISIT THE HOUSE
              </h1>
            ...
            <div className="space-y-6 border-l border-line pl-6">
              <div>
                <h3 className="text-[11px] uppercase tracking-widest font-semibold text-ink mb-2">
                  Hours
                </h3>
              ...
              <div>
                ...
                <br />
                <ObfuscatedEmailLink
                  className="font-body text-clay hover:text-clay/80 text-base transition-colors inline-block hover:underline mt-2"
                >
                  Email Us Directly
                </ObfuscatedEmailLink>
              </div>
          ...
          <div className="space-y-6">
            <div className="w-full h-[400px] overflow-hidden border border-line">
              <iframe
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full py-4 border border-clay text-clay text-center hover:bg-clay hover:text-paper transition-all duration-300 tracking-widest text-xs font-medium"
            >
              OPEN IN GOOGLE MAPS
            </a>
          </div>
