  ...
  return (
    <footer className="bg-bakery-dark border-t border-bakery-cream/10 py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 mb-12">
          ...
          <div className="flex flex-col items-center md:items-start space-y-6">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-center space-y-4 md:space-y-0 md:space-x-6">
              <div className="w-40 h-40 rounded-full overflow-hidden bg-bakery-cream/10 p-2 flex items-center justify-center">
                <Image
                  src="/SBH_logo.svg"
          ...
          {/* Right Column - Location, Contact, Socials */}
          <div className="grid sm:grid-cols-3 gap-8 text-center md:text-left">
            {/* Location */}
            <div>
              <h3 className="font-heading text-bakery-cream text-lg mb-4 tracking-wider">
                LOCATION
              </h3>
        ...
        {/* Bottom Copyright */}
        <div className="pt-8 border-t border-bakery-cream/10 text-center">
          <p className="font-body text-bakery-cream/60 text-sm">
            © {currentYear} Sim Baking House. All rights reserved. | Handcrafted in Penang
          </p>
        </div>
      </div>
    </footer>
